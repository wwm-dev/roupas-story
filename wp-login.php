...
<html lang="pt-BR">
	...
	<title>Acessar &lsaquo; Loja de Roupas &#8212; WordPress</title>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="./index.html">&larr; Ir para Loja de Roupas</a>		</p>
			</div>
...
var _wpUtilSettings = {"ajax":{"url":"\/loja-roupas\/wp-admin\/admin-ajax.php"}};
</script>
<script src="./wp-includes/js/wp-util.min.js?ver=5.8.1" id="wp-util-js"></script>
<script id="user-profile-js-extra">
var userProfileL10n = {"user_id":"0","nonce":"0a72557213"};
</script>
